<template>
  <div>
      ...
      <div class="row SheetsFormRenderSection__container">
          <sheets-form-render-fields v-for="(field, index) in formSection.fields" :key="index" :field="field" v-model="sectionModel[index]"></sheets-form-render-fields>
      </div>
  </div>
</template>

<script>
import SheetsFormRenderFields from './SheetsFormRenderFields.vue';
export default {
